...
import {disableInterface, EvaluateInput, UpdateJsonFormValue} from "./app.interface";
...
export class ApiService {
  ...
  async putApiCall(url: string, params: UpdateJsonFormValue | disableInterface | EvaluateInput[]): Promise<any> {
    try {
